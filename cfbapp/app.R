...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      selectizeInput("team1", "Home Team",   choices = teamNames, multiple = FALSE, selected = teamNames[80]),
      selectizeInput("team2", "Away Team", choices = teamNames, multiple = FALSE, selected = teamNames[87]),
      numericInput("spread", "Home Team's Spread", value = -4, min = -80, max = 80),
      numericInput("moneyLine1", "Home Team's Moneyline",value = -180, min = -12000, max = 12000),
      numericInput("moneyLine2", "Away Team's Moneyline",value = 155, min = -12000, max = 12000),
